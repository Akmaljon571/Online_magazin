...
function Header() {
  ...
  const onSearch = (evt) => console.log(evt.target.value);

  return (
    <header className="header">
      <div className="header">
        <div className="navbar">
            <span onClick={menu} className="header_menu">
          ...
          <div onChange={onSearch} className="header_search">
            <input type="text" className="header_input" placeholder="Kategoriya" />
            <span className="header_svg">P</span>
          </div>
              <div className="tell_Link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
                      ...
                      <Link className="tell_nomer" to="tel:+998900456961">
